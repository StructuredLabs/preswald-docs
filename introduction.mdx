...
- Configure your app effortlessly with a `config.toml` file—perfect for quick changes to themes, branding, or connections.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="rocket"
    href="https://demo.preswald.com"
  >
    Turn a natural language prompt into a live data app in seconds.
  </Card>
